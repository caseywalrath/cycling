...
// percentile formula and phenotype rules are the original code, unchanged (Phase 6 changes
// only the input source). Two small Phase 3 changes: the Rider Type modal is a Sheet, and a
// power bar's tooltip opens on tap (it was hover-only, which a phone can't do).
export default function PowerSkillsCard() {
  const { powerCurveData } = useAppData();
